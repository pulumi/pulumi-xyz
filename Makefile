...
# Re-run if the upstream commit or the patches change. Only call upstream.sh if it exists.
.make/upstream: $(wildcard patches/*) $(shell type ./upstream.sh &>/dev/null && ./upstream.sh file_target)
